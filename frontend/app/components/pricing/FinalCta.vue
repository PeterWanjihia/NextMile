...
import { pricingFinalCta } from '~/data/pricing';
</script>
    ...
    <UiContainer>
      <div
        class="
          ...
          sm:px-6
          lg:grid-cols-[auto_minmax(0,1fr)_minmax(28rem,0.9fr)]
          lg:gap-6 lg:px-7
        "
      >
        <div
        ...
        >
          <UiButton
            :to="pricingFinalCta.primaryAction.to"
            size="md"
            class="w-full whitespace-nowrap"
          >
            {{ pricingFinalCta.primaryAction.label }}
          </UiButton>
